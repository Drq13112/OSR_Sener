...
class TrajectoryFollower(Node):
    ...
    def follow_path(self):
        ...
        print("distancia a punto", distance)

        # Compute the angle to the goal
        angle_to_goal = self.angle_to_goal(self.current_pose, goal_pose) # add .position
        ...
        print("angulo en grados",angle_to_goal_degrees)
        ...
        if -5 < angle_to_goal_degrees and angle_to_goal_degrees < 5:
    ...
    def angle_to_goal(self, current_pose, goal_pose):
        ...
        print("angulo robot *********", current_yaw)
        ...
        print("anguo target**********", target_angle)
        ...
        print("angle_diff_corregido",angle_diff)
        return angle_diff
