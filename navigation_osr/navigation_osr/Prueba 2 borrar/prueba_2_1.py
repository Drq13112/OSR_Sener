...
class LaserScanProcessor(Node):
    def __init__(self):
        ...
        self.cmd_vel_publisher = self.create_publisher(Twist, '/cmd_vel_4', 10)
    ...
    def callback(self, data):
        ...
        if len(target_ranges) == 5:
            ...
            print("errores", error_frontal, error_lateral)
            ...
            print(error_centro_trayectoria)

            twist = Twist()
            twist.linear.x = linear_speed - error_centro_trayectoria * 0.4
            twist.angular.z = -angular_speed - error_centro_trayectoria * 0.8
